...
public class MyPanelListAdapter extends PanelListAdapter {
    ...
    private class ContentAdapter extends ArrayAdapter {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            viewHolder.tv_11.setText(data.get("11"));
            viewHolder.tv_12.setText(data.get("12"));
            viewHolder.tv_13.setText(data.get("13"));
            viewHolder.tv_14.setText(data.get("14"));
            viewHolder.tv_15.setText(data.get("15"));
            viewHolder.tv_16.setText(data.get("16"));
        ...
        private class ViewHolder {
            ...
            ViewHolder(View itemView) {
                ...
                tv_11 = (TextView) itemView.findViewById(R.id.id_tv_11);
                tv_12 = (TextView) itemView.findViewById(R.id.id_tv_12);
                tv_13 = (TextView) itemView.findViewById(R.id.id_tv_13);
                tv_14 = (TextView) itemView.findViewById(R.id.id_tv_14);
                tv_15 = (TextView) itemView.findViewById(R.id.id_tv_15);
                tv_16 = (TextView) itemView.findViewById(R.id.id_tv_16);
